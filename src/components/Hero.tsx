    ...
    <section className="min-h-screen flex flex-col items-center justify-center relative px-4">
      <div className="animate-fade-in text-center">
        <img
          ...
          className="w-32 h-32 md:w-40 md:h-40 mx-auto mb-8 animate-slide-up"
        />
        ...
        {!isMobile && (
          <div className="bg-card border border-border rounded-lg p-6 md:p-8 mb-8 max-w-2xl mx-auto font-mono text-left">
        ...
        {isMobile && (
          <div className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto space-y-2">
      ...
      <button
        ...
        className="absolute bottom-8 animate-bounce hover:text-primary transition-colors"
